...
Resource.extend = function (prototype) {
  ...
  for (var prop in prototype) {
    if (prototype.hasOwnProperty(prop)) {
      ...
      } else if (typeof prototype[prop] === 'object') {
...
/**
 * Update all resources using given `query`.
 *
 * @param {Object} query
 * @param {Array} changes array of updates
 * @param {Function(err, resources, changes)} callback
 * @return {Resource}
 */
